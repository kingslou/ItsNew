...
import com.loujin.material.SlidingTabLayout;
import com.loujin.material.ViewPagerAdapter;
...
public class SampleActivity extends ActionBarActivity {
	...
	ViewPager pager;
	private String titles[] = new String[] { "最新发布", "流行文章", "最热文章" };
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		String[] values = new String[] { "默认", "红色主题", "蓝色主题",
				"夜间模式" };
		...
		mDrawerList
				.setOnItemClickListener(new AdapterView.OnItemClickListener() {
					...
					public void onItemClick(AdapterView<?> parent, View view,
						...
						switch (position) {
						case 0:
							mDrawerList.setBackgroundColor(getResources()
									.getColor(R.color.material_deep_teal_500));
							toolbar.setBackgroundColor(getResources().getColor(
									R.color.material_deep_teal_500));
							slidingTabLayout.setBackgroundColor(getResources()
									.getColor(R.color.material_deep_teal_500));
